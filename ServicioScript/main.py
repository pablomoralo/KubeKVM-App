        ...
        if deployments:#Si no esta vacia
            for deployment in deployments:
                ...
                if deployment['estado']=='Pendiente':
                    ...
                    #print(newUrl)
                    updateDeployment('http://10.110.97.67:80/deployments/editDeployment/'+deployment['_id'], 'Activo')
                    ...
                    for i in range(len(deploymentsDictionary)):
                        if deploymentsDictionary.keys()[i]==deployment['_id']:#diccionario.keys devuelve una tupla con id y nombresMaquinas
                            checkState('http://10.110.97.67:80/deployments/editDeployment/', deploymentsDictionary.items()[i])
...
if __name__ == '__main__':
    ...
    url='http://10.110.97.67:80/deploymentsScript'
